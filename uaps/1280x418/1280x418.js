...
lib.ssMetadata = [
		{name:"1280x418_atlas_1", frames: [[1282,0,493,171],[1282,173,390,63],[0,0,1280,418]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,390,63);
...
p.nominalBounds = new cjs.Rectangle(0,0,493,171);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(741,301.5,1,1,0,0,0,195,31.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({_off:false},0).to({y:321.5,alpha:1},30,cjs.Ease.get(1)).wait(151));

	// Layer_8
	this.instance_1 = new lib.Symbol34("synched",0);
	this.instance_1.setTransform(754.5,191.5,1,1,0,0,0,246.5,85.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:764.5,alpha:1},29,cjs.Ease.get(1)).wait(181));
